...
public class GraphPanel2 extends JPanel {
    ...
    public GraphPanel2(List<Integer> scores, String panel, List<Point> graphPoints, int w, int h, List<String> timeTicks) {
	...
	protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < graphPoints.size(); i++) {
            ...
            //g2.setFont(new Font("cambria", 8, Font.PLAIN));
           // g2.drawString(x+","+y, x, y+5);
        }
    }
	/*
...
//    }
    ...
    private static void createAndShowGui() {
        ...
        GraphPanel2 mainPanel = new GraphPanel2(scores, "g75", graphPoints, 800, 600, null);
