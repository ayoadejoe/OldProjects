...
public class TankGraph extends JPanel{
	...
	public TankGraph(List<Object> data2,  String date, String gen) {
	...
	private static TankGraph graph;
	...
	public static void main(String[] args) {
		...
		graph = new TankGraph(defaulT, "g75", today.toLocaleString());
		...
		refresh.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				frame.remove(graph);
				graph = new TankGraph(data, "g75", today.toLocaleString());
