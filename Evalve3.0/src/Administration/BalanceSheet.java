...
public class BalanceSheet extends JFrame{
	...
	public BalanceSheet() {
		...
		setUndecorated(true);
		Headings = acquire.Account("BalanceHeader");
		Data = acquire.Account("BalanceData");
		getRootPane().setWindowDecorationStyle(JRootPane.QUESTION_DIALOG);
		setVisible(true);
		setSize(850, 400);
		model = new BalanceTableModel(Headings, 0);
				...
				if(e.getButton() == 3){
					...
					menuItem1.addActionListener(new ActionListener(){
						public void actionPerformed(ActionEvent w) {
							...
							model.addColumn(d);
							acquire.alterTable("balancesheet", "column", d);
					 ...
					 menuItem3.addActionListener(new ActionListener(){
							public void actionPerformed(ActionEvent w) {
								model.addRow(yes);
								String d = "row";
								acquire.alterTable("balancesheet", "row", d);
							}
					    });
					 ...
					 menuItem5.addActionListener(new ActionListener(){
							public void actionPerformed(ActionEvent w) {
								...
								String d = Table.getModel().getColumnName(f);
								//("The Column:"+d);
								acquire.alterTable("balancesheet", "removeCol", d);
							}
					    });
					 ...
					 menuItem2.addActionListener(new ActionListener(){
							public void actionPerformed(ActionEvent w) {
								...
								String rowNo = (d+1)+"";
								//("The No:"+rowNo);
								acquire.alterTable("balancesheet", "removeRow", rowNo);
							}
					    });
				}
			}
