...
public class JosephFrame extends JPanel {
	...
	private JComboBox inpChannel = new JComboBox();
	...
	public void Joseph() {
		...
		inpChannel.setForeground(new Color(204, 153, 51));
	...
	public String[] availableMixerLines(){
		Mixer.Info[] mixerInfo = AudioSystem.getMixerInfo(); 
		String[] mixers = new String[mixerInfo.length];
		 for(int z = 0; mixerInfo.length>z; z++){
			 mixers[z] = mixerInfo[z].toString();
	    	 System.out.println(mixers[z]);
