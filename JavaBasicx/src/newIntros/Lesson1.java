...
public static void main(String[] args) {
    ...
    sb.replace(0,10,"howdy");			//does not throw exception
    ...
    sb.subSequence(0,3);
    System.out.println("subSequence:"+sb);
    char char01 = sb.charAt(0);
    System.out.println("CharAt 0: "+char01);
    System.out.println("First l: " + sb.indexOf("l"));
    System.out.println("Last l: " + sb.lastIndexOf("w"));
}
}