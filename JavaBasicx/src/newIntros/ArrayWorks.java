...
public static void main(String... args) {
    ...
    /*
        subList
     */
    List<String> first = arrayBacked.subList(0,2); // get first element
